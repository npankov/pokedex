...
export class PrincipalPageComponent implements OnInit {
  ...
  constructor() {
    this.listPokemon = [
      ...
      new Pokemon("Melofee", "#100", "Normal", "Très recherché pour son aura mystique, il est très rare et ne vit que dans des endroits précis.", "0.6 m", "7.5 kg", "Non", './assets/image/004.png'),
      ...
      new Pokemon("Insecateur", "#123", "Insect", "    Rapide et agile comme un ninja, il se déplace si vite qu'il crée l'illusion d'être en groupe.", "1.5 m", "56 kg", "Non", './assets/image/009.png')
    ]
  }
